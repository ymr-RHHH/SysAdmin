...
## Setting up 
This lab can be completed either on tsunami by logging in using ssh or on the VM you set up in the previous lab. This lab requires a bash shell, `vim`, and `tmux`. If you do not have tmux or vim installed: `sudo apt install vim tmux`
...
![tmux layout](Lab 2 - Core Shell & Shell Scripting _ OCF Sysadmin DeCal.assets/tmux-layout.png)
...
Before you jump into the assignment we reccomend reading through our [Scripting Reference](https://decal.ocf.berkeley.edu/labs/scripting/) which provides a introduction to Bash and Python(optional part in this lab) scripting in Linux. Feel free to come back to this reference as you work through the assignment.
...
[Tmux cheat sheet](https://gist.github.com/MohamedAlaa/2961058)
 ...
 [![Previous](Lab 2 - Core Shell & Shell Scripting _ OCF Sysadmin DeCal.assets/backward.svg "Lab 1 - Unix, the Shell, OSS") Lab 1 - Unix, the Shell, OSS](https://decal.ocf.berkeley.edu/labs/1/) [Lab 3 - Packages and Packaging ![Next](Lab 2 - Core Shell & Shell Scripting _ OCF Sysadmin DeCal.assets/forward.svg "Lab 3 - Packages and Packaging")](https://decal.ocf.berkeley.edu/labs/3/) 

 [![](Lab 2 - Core Shell & Shell Scripting _ OCF Sysadmin DeCal.assets/jane-street.svg)](https://www.janestreet.com/)Thanks to [Jane Street](https://www.janestreet.com/) for supporting the DeCal.

[![Hosted by the OCF](Lab 2 - Core Shell & Shell Scripting _ OCF Sysadmin DeCal.assets/ocf-hosted-penguin.svg)](https://www.ocf.berkeley.edu/) Copyright © 2017-2025 [Open Computing Facility](https://www.ocf.berkeley.edu/) and [eXperimental Computing Facility](https://xcf.berkeley.edu/)
